import { User, UserTC, RideTC, PersonalCarTC } from "../models";
import {
    authenticateTicket,
    verifyToken,
    createToken,
...
UserTC.addRelation("personalCars", {
    resolver: () => PersonalCarTC.getResolver("findById"),
    args: PersonalCarTC.getInputTypeComposer(),
    prepareArgs: {
        _id: (source) => source.personalCar,
    },
    projection: { personalCar: 1 },
});
