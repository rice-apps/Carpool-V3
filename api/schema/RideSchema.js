...
import { RideTypeTC } from "../models/RideTypeModel";
...
RideTC.addRelation("rideType", {
  resolver: () => RideTypeTC.getResolver("findById"),
  args: UserTC.getInputTypeComposer(),
  prepareArgs: {
    _id: (source) => source.rideType,
  },
  projection: { rideType: 1 },
});
