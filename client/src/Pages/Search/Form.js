...
let PossibleLocations = [
  ...
  return (
    <React.Fragment>
    <FormOnly allRides={props.allRides} setAllRides={props.setAllRides} resultRides={resultRides} displayRef={displayRef} getRidesRefetch={props.getRidesRefetch} getLocsRefetch={props.getLocsRefetch} testLocations={PossibleLocations}/>
    </React.Fragment>
  )
}
